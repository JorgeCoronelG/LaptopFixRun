...
import com.laptopfix.laptopfixrun.Activities.Technical.CurrentServiceDetailActivity;
...
public class NowServiceFragment extends Fragment implements ValueEventListener, DatesTechnicalAdapter.OnDateListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_now_service_tech, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getString(R.string.now_service));
    }
    ...
    public void onDateClick(int position) {
        Intent intent = new Intent(getActivity(), CurrentServiceDetailActivity.class);
